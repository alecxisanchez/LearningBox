        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="nombre_unidad" class="col-sm-3 col-form-label form-label">* Categoria : </label>
                        <div class="col-sm-6 col-md-6">
                            <select id="und_cat" class="custom-control custom-select form-control">
                                <option value="-99" selected>--- Seleccione ---</option>
                                @foreach($lstCategorias as $item)
                                    <option value="{{ $item->tr_cat_id }}">{{ $item->tr_cat_id }} - {{ $item->tr_cat_nombre }}</option>
                                @endforeach
                    ...
                    <div class="form-group row">
                        <label for="nombre_unidad" class="col-sm-3 col-form-label form-label">* Curso : </label>
                        <div class="col-sm-6 col-md-6">
                            <select id="und_cur" class="custom-control custom-select form-control">
                                <option value="-99" selected>--- Seleccione ---</option>
                                @foreach($lstCategorias as $item)
                                    <option value="{{ $item->tr_cat_id }}">{{ $item->tr_cat_id }} - {{ $item->tr_cat_nombre }}</option>
                                @endforeach
                    ...
                    <div class="form-group row">
                        <label for="nombre_modulo" class="col-sm-3 col-form-label form-label">* Modulo : </label>
                        <div class="col-sm-6 col-md-6">
                            <select id="und_mod" class="custom-control custom-select form-control">
                                <option value="-99" selected>--- Seleccione ---</option>
                                @foreach($lstCategorias as $item)
                                    <option value="{{ $item->tr_cat_id }}">{{ $item->tr_cat_id }} - {{ $item->tr_cat_nombre }}</option>
                                @endforeach
                    ...
                    <div class="form-group row">
                        <label for="nombre_unidad" class="col-sm-3 col-form-label form-label">* Nombre : </label>
                        <div class="col-sm-6 col-md-6">
                            <input id="nomb_und" type="text" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="descripcion_unidad" class="col-sm-3 col-form-label form-label">* Descripción :</label>
                        <div class="col-sm-6 col-md-6">
                            <textarea id="desc_und" rows="3" cols="50" class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="estado_unidad" class="col-sm-3 col-form-label form-label">* Estado :</label>
                        <div class="col-sm-6 col-md-4">
                            <select id="edo_und" class="custom-control custom-select form-control">
                                <option value="-99" selected>--- Seleccione ---</option>
                    ...
                    <div class="form-group row">
                        <label for="vigencia_unidad" class="col-sm-3 col-form-label form-label">* Vigencia :</label>
                        <div class="col-sm-6 col-md-4">
                            <select id="vig_und" class="custom-control custom-select form-control">
                                <option value="-99" selected>--- Seleccione ---</option>
