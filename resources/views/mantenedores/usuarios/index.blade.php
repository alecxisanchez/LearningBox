                ...
                <div class="col-lg-12">
                    ...
                    <div class="card shadow p-3 mt-2 table-responsive">
                        <div  style="text-align: center;">
                            <a id="btn_agregar_usu" class="btn btn-primary btn-primary-ac btn-sm"><i class="material-icons">add</i></a>
                                ...
                                @foreach($lstUsuarios as $item)
                                    <tr id="tr_{{ $item->tr_uuid }}">
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-primary btn-primary-ac btn-sm" data-uuid="{{$item->tr_uuid}}" id="btn_edit_usu" href="#"><i class="material-icons btn__icon--left">edit</i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
