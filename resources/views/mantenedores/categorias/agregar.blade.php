                ...
                <div class="col-lg-12">
                    ...
                    <div class="card shadow p-3 mt-2 table-responsive">
                        <div  style="text-align: center;">
                            <a id="btn_agregar_cat" class="btn btn-primary btn-primary-ac btn-sm"><i class="material-icons">add</i></a>
                            ...
                            @foreach($lstCategorias as $item)
                                <tr id="tr_{{ $item->tr_uuid }}">
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary btn-primary-ac btn-sm" data-uuid="{{$item->tr_uuid}}" id="btn_edit_cat" href="#"><i class="material-icons btn__icon--left">edit</i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success btn-primary-ac" id="btn_save_cat" value=""></button>
                </div>
            </div>
        </div>
    </div>
