                ...
                <div class="col-lg-12">
                    ...
                    <div class="card shadow p-3 mt-2 table-responsive">
                        <div  style="text-align: center;">
                            <a id="btn_agregar_mod" class="btn btn-primary btn-primary-ac btn-sm"><i class="material-icons">add</i></a>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success btn-primary-ac" id="btn_save_mod" value=""></button>
                </div>
            </div>
        </div>
    </div>
