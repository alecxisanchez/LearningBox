...
<div class="card">
    <ul class="nav nav-tabs nav-tabs-card">
        <li class="nav-item">
            <a class="nav-link active" href="#first" data-toggle="tab">Cuenta</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#second" data-toggle="tab">Pagos</a>
        </li>
    </ul>
    <div class="tab-content card-body">
        <div class="tab-pane active" id="first">
            <form action="#" class="form-horizontal">
                        ...
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <div class="custom-file" style="width: auto;">
                                    ...
                                    <label for="avatar" class="custom-file-label">Elige imagen</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    <label for="name" class="col-sm-3 col-form-label form-label">Nombre Completo</label>
                    <div class="col-sm-8">
                        <div class="row">
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" placeholder="Nombre Completo" value="Pedro">
                            </div>
                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control" placeholder="Last Name" value="Perez">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="input-group">
                            ...
                            <input type="text" id="website" class="form-control" placeholder="www." value="learnplus.frontendmatter.com">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
